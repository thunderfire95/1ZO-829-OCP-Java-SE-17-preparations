...
```
[Full Example](../src/main/java/org/vijin/ocp17/book/ch7/interfaces/defaultmethods/InheritTwoDefaultMethods.java)
#### Case abstract class
[Abstract class default methods](../src/main/java/org/vijin/ocp17/book/ch7/interfaces/defaultmethods/AbstractClassDefaultMethods.java)
...
```
[default vs abstract conflict](../src/main/java/org/vijin/ocp17/book/ch7/interfaces/defaultmethods/DefaultVsAbstractConflict.java)
### private methods
...
[Inherit two default methods with the same signature](../src/main/java/org/vijin/ocp17/book/ch7/interfaces/defaultmethods/InheritTwoDefaultMethods.java)
...
[DefaultMethodCallingOtherMethods](../src/main/java/org/vijin/ocp17/book/ch7/interfaces/defaultmethods/DefaultMethodCallingOtherMethods.java)
### static methods
...
[interface with static methods](../src/main/java/org/vijin/ocp17/book/ch7/interfaces/InterfaceWithStaticMethods.java)
## Sealed
...
```
[Example of sealed interface](../src/main/java/org/vijin/ocp17/book/ch7/sealed/interfaces/Pet.java)
...
```
[sealed nested](../src/main/java/org/vijin/ocp17/book/ch7/sealed/SealedNested.java)
...
```
[Enum With Fields](../src/main/java/org/vijin/ocp17/book/ch7/useofenum/SeasonWithValues.java)
...
```
[University](../src/main/java/org/vijin/ocp17/book/ch7/nested/inner/University.java)
### Nested Local Class
...
```
[Nested Local Class](../src/main/java/org/vijin/ocp17/book/ch7/nested/local/ArraySorter.java)