...
```
[StringBuilder Methods](../src/main/java/org/vijin/ocp17/book/ch4/UsageOfStringBuilder.java)
...
```
[Multi Dimensional Array](../src/main/java/org/vijin/ocp17/book/ch4/array/MultiDimensionalArray.java)
...
#
```
[indent](../src/main/java/org/vijin/ocp17/book/ch4/string/BasicIndent.java)
...
System.out.println(source.translateEscapes());
```
[translateEscapes](../src/main/java/org/vijin/ocp17/book/ch4/string/TranslatingEscapes.java)